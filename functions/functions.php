<?php
	...
	function single_post(){
		...
		if (isset($_GET['post_id'])) {
			...
			//comment variable of user who comment
			$user_com = $_SESSION['user_email'];
			$get_com = "SELECT * from user where user_email='$user_com'";
			...
			if($p_id != $post_id ){
							...
							<div class='panel panel-info'>
								<div class='panel-body'>
									<form action='' method='post' class='form-inline'>
										<textarea class='pb-cmnt-textarea' name='comment' placeholder='Write your comment here!'></textarea>
				...
				if (isset($_POST['reply'])) {
					...
					if ($comment == "") {
						...
						$insert = "INSERT into comments(post_id,user_id,comment,comment_author,datee) values ('$post_id','$user_id','$comment','$user_com_name',NOW())";
	...
	function user_posts(){
		...
		while ($row_posts = mysqli_fetch_array($run_posts)) {
			...
			$getuser = "SELECT user_email from user where user_id='$u_id'";
				...
				if($content=="No" && strlen($upload_image) >= 1){
					...
					<div class='row'>
						...
						<div id='posts' class='col-sm-6'>
							...
							<div class='row'>
								<div class='col-sm-12'>
									<h3><p style='float:left;'>$content</p></h3>
								</div>
							</div><br>
						</div>
						<div class='col-sm-3'>
	...
	function search_user(){
		...
		if (isset($_GET['search_user_btn'])) {
			...
			$get_user = "SELECT * from user where f_name like '%$search_query%' OR l_name like '%$search_query%' OR user_name like '%$search_query%'";
		}
		else{
				...
				<div class='row'>
					...
					<div class='col-sm-6'>
						<div class='row' id='find_people'>
							<div class='col-sm-4'>
								<a href='user_profile.php?u_id=$user_id'><img src='users/$user_image' width='150px' height='140px' title='$username' style='float:left; margin:1px;'/></a>
