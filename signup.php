				...
				<div class="1-part">
					<form action="" method="post">
						...
						<div class="input-group"> 
							...
							<input id="password" type="password" class="form-control" placeholder="Passowrd" name="u_pass" required="required">
						</div><br>
						...
						<center>
							<button id="signup" class="btn btn-info btn-lg" name="sign_up">
								Signup
							</button>
						</center>
						<?php
