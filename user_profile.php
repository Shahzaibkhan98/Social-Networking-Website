		...
		<div class="col-sm-12">
			...
			<?php
				...
				if (isset($_GET['u_id'])) {
					...
					//if user enter on its own id/username
			...
			<div class="col-sm-8">
				...
				<?php
					...
					$get_posts = "SELECT * from posts where user_id='$u_id' ORDER BY 1 Desc limit 6";
							...
							echo "
								...
								<div id='own_posts'>
									<div class='row'>
										<div class='col-sm-2'>
											<p>
												<img src='users/$user_image' class='imgcircle' width='100px' height='100px'>
											</p>
										</div>
										<div class='col-sm-6'>
											<h3>
												<a style='text-decoration:none; cursor:pointer; color: #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name
												</a>
											</h3>
											<h4>
								...
								<div id='own_posts'>
									...
									<div class='row'>
										...
										<div class='col-sm-6'>
											...
											<h4>
												<small style='color:black;'>Updated a post on <strong>$post_date</strong>
												</small>
											</h4>
