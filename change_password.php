			...
			<div class="main-content">
				...
				<div class="l_pass">
					<form action="" method="post">
						...
						<center>
							<button id="signup" class="btn btn-info btn-lg" name="change">
								Change Password
							</button>
						</center>
					</form>
	...
	if (isset($_POST['change'])) {
		...
		if ($pass == $pass1) {
			...
			if(strlen($pass) >= 6 && strlen($pass) <= 60){
				...
				echo "
					<script>alert('Your Password is changed a moment ago')</script>
				";
				...
				echo "
					<script>alert('Your Password should be greater than 6 letters')</script>
				";				
			}
		}
		else{
			echo "
				<script>alert('Your Password did not match')</script>
			";
