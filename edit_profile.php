				...
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" onclick="show_password()"><strong>Show Passowrd</strong>
						</td>
					</tr>
											...
											<?php
												if (isset($_POST['sub'])) {
													...
													if ($bfn == "") {
														...
														echo "
															<script>window.open('edit_profile.php?u_id=$user_id','_self')</script>
														";
...
<?php
	if (isset($_POST['update'])) {
		...
		$update = "UPDATE user set f_name='$f_name', l_name='$l_name', user_name='$u_name', describe_user='$describe_user', relationship='$Relationship_status', user_pass='$u_pass', user_email='$u_email', user_country='$u_country', user_gender='$u_gender', user_birthday='$u_birthday' where user_id='$user_id'";

		$run = mysqli_query($con,$update);

		if($run){
			echo "
				<script>alert('Your Profile Updated')</script>
			";
