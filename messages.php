				...
				while ( $row_user = mysqli_fetch_array($run_user) ) {
					...
					echo "
						<div class='container-fluid'>
							...
							<a style='text-decoration: none; cursor: pointer; color: #3897F0;' href='messages.php?u_id=$user_id'><img class='img-circle' src='users/$user_image' width='90px' height='80px' title='$user_name' ><strong>&nbsp $first_name $last_name</strong><br><br>
							</a>
			...
			<?php
				...
				if (isset($_POST['send_msg'])) {
					...
					if ($msg == "") {
						...
						echo "
							<h4 style='color: red; text-align: center;'>Message is too long! Use only 50 characters</h4>
						";
					
					}else{
						$insert = "INSERT into user_messages(user_to,user_from,msg_body,datee,msg_seen) values('$user_to_msg','$user_from_msg','$msg',NOW(),'no')";
